...
import type { GetPublicKey } from '../types'
import type {
  EosGetPublicKey,
  RippleGetAddress,
  BinanceGetAddress,
...
export class DPubkeyController extends Controller {
  ...
  public async getPublicKeys(@Body() body: GetPublicKey[]): Promise<(PublicKey | null)[]> {
    return new Promise<(PublicKey | null)[]>(async (resolve, reject) => {
